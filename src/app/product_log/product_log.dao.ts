...
import { ProductLog } from './product_log.entity';

const tableName = 'product_logs';

@Injectable()
export class ProductLogDao {
  constructor(private readonly _db: AppDB) {}

  async add(data: ProductLog) {
    try {
  ...
  async list(query) {
    try {
      ...
      const criteria = builder
        ...
        .conditionIfNotEmpty('created_by', '=', query.created_by)
